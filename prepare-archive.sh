...
sql_group["example"]="Examples";                            orders+=( "example" )
...
sql_group["erp"]="Oracle Applications";                     orders+=( "erp" )
sql_group["owi"]="Oracle Wait Interface";                   orders+=( "owi" )
sql_group["plsql"]="PL/SQL";                                orders+=( "plsql" )
...
sql_group["perf"]="Tuning";                                 orders+=( "perf" )
